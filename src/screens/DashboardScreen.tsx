...
export default function DashboardScreen() {
  ...
  // Por ahora solo la Terminal está portada; Inventario/Reportes se
  // agregan en próximas tareas de la Fase 1.
  if (effectiveTab === 'inventario' || effectiveTab === 'reportes') {
    return (
      <div className="flex h-full w-full flex-col bg-[var(--color-background)]">
        <div className="flex flex-1 items-center justify-center">
          <div className="glass-surface rounded-lg px-8 py-6">
            <h2 className="text-[var(--font-large)] font-semibold text-[var(--color-text)]">
              {effectiveTab === 'inventario' ? 'Inventario' : 'Reportes'}
            </h2>
